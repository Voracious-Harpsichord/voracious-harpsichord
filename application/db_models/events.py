...
class Event(db.Model):
    ...
    action = db.Column(db.String(140)) #..."added an article"
    view_type = db.Column(db.String(140)) #the type of thing that was added ie product, blog
    data_id = db.Column(db.Integer) #the id for the type of thing that was added, to retrive more info about it
    time_stamp = db.Column(db.String(140)) #when the action was performed
